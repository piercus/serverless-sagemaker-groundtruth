					...
					return page.goto(url, {waitUntil: 'networkidle0'})
						...
						.then(() => {
							return page.waitForFunction(() => {
								...
								return page.screenshot({path: './puppeteer-screenshot.png'}).then(() => {
									throw(new Error('Not able to get the code from the page, the json output should appear in a $("table code") element, (screenshot saved in ./puppeteer-screenshot.png)'))
								})
							})
							.then(a => a.jsonValue());
						});
